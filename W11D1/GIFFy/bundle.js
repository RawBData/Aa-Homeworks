...
function (_React$Component) {
  ...
  _createClass(GiphysIndex, [{
    ...
    value: function render() {
      ...
      var gifs = this.props.gifs; // debugger

      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, gifs.map(function (gif) {
...
function (_React$Component) {
  ...
  function GiphysIndexItem(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(GiphysIndexItem).call(this, props));
  }
  ...
  _createClass(GiphysIndexItem, [{
    ...
    value: function render() {
      console.log(this.props);
      var gif = this.props.gif; // debugger
...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var answer = this.props.fetchSearchGiphys(this.state.searchTerm);
      console.log(answer);
      this.setState({
        searchTerm: ''
      });
    ...
    key: "render",
    value: function render() {
      var gifs = this.props.giphys;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Giffy Fun"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
        ...
        type: "submit",
        value: "Search Giffy"
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
        gifs: gifs
      })));
    }
  }]);
...
var something = _reducers_root_reducer__WEBPACK_IMPORTED_MODULE_2__["default"];
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  ...
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=dc6zaTOxFJmzC&limit=5&rating=r")
  });
};
